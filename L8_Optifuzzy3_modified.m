...
Mu1 = triangle(x,-17.5,-13,-22); Mu2 = triangle(x,-13,-8.5,-17.5);
Mu3 = triangle(x,-8.5,-1,-13);   Mu4 = triangle(x,-1,10,-8.5);
Mu5 = triangle(x,10,12,-1);      Mu6 = triangle(x,12,15,10);
Mu7= triangle(x,15,20,12);
